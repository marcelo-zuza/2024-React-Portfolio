    ...
    <div className='py-8 px-4'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 py-4 text-white">
            ...
            ">
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-0 md:grid-cols-2 place-items-center p-4 text-center md:text-left">
                    <div className="col-span-1 py-4 px-4 md:py-0 border-white border-2 md:border-0 rounded-xl h-64 md:h-60 flex flex-col justify-center content-center items-center hover:bg-sky-600 duration-500">
                    ...
                    <div className="col-span-1 py-4 px-4 md:py-0 border-white border-2 md:border-0 rounded-xl h-64 md:h-60 flex flex-col justify-center content-center items-center hover:bg-sky-600 duration-500">
                        <div className="grid grid-cols-1 place-items-center py-4">
                            <a className="" href="https://br.fiverr.com/marcelo_zuza"><img className="h-14 md:h-24" src={Fiverr} alt="fiverr" /></a>
                        </div>
        ...
        <div className="my-10 grid grid-cols-1 place-items-center">
                <form className='text-white bg-neutral-900 mx-4 px-8 md:w-1/2 rounded-lg py-4'>
                    <h1 className="text-3xl text-center py-4 md:py-4">Fale por Email</h1>
                    <div className="flex flex-col items-center text-black">
                        <input className='w-80 md:w-96 py-2 px-2 rounded-lg my-2' type="text" placeholder='Insira seu nome' />
                        <input className='w-80 md:w-96 py-2 px-2 rounded-lg my-2' type="email" placeholder='Insira seu email' />
                        <input className='w-80 md:w-96 h-32 py-2 px-2 rounded-lg my-2' type="text" placeholder='Mensagem' />
