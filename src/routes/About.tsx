...
const About = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 py-0 md:py-20 px-2 pb-0 md:px-4">
        <div className="col-span-1 grid grid-cols-1 place-items-center md:place-content-start fade-in-element first-element
        ">
            <img className="md:h-full" id="animateDiv" src={Website} alt="website" />
        </div>

        <div className="col-span-1 text-center md:text-left md:pt-12 fade-in-element third-element text-white
        ">
            ...
            <div className="py-4">
                <a href="/about.html" className="bg-sky-600 my-4 py-4 px-4 md:py-4 md:px-6 rounded-full border-white  text-white hover:bg-white hover:text-neutral-900 duration-500">Sobre mim</a>
            </div>
        </div>
